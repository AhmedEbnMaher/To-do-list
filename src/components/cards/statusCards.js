...
props.getTasks()
  ...
  return (
    <div>
    <div><h6>In Progress Tasks</h6></div>
<div className='d-flex flex-wrap todos-wrapper'>
{props.tasks.filter(tsk => tsk.status === 'in progress').map((task,idx)=>(
...
<div><h6>To-do Tasks</h6></div>
<div className='d-flex flex-wrap todos-wrapper'>
{props.tasks.filter(tsk => tsk.status === 'to-do').map((task,idx)=>(
<div className='card-task ml-4' key={idx}>
<div className='card-body p-0' >
<div className='text-center card-badge d-flex justify-content-between'>
<span >{task.name}</span>
...
<div><h6>Done Tasks</h6></div>
<div className='d-flex flex-wrap todos-wrapper'>
{props.tasks.filter(tsk => tsk.status === 'Done').map((task,idx)=>(
<div className='card-task ml-4' key={idx}>
<div className='card-body p-0' >
<div className='text-center card-badge d-flex justify-content-between'>
<span >{task.name}</span>
